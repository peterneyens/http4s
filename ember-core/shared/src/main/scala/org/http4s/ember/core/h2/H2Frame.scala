...
private[ember] object H2Frame {
  ...
  final case class Unknown(raw: RawFrame) extends H2Frame {
    ...
    private[h2] def frameType: Byte = raw.`type`
  }
  ...
  final case class Data(
    ...
    private[h2] def frameType: Byte = Data.`type`
  }
  object Data {
    final val `type` = 0x0
    // 2 flags
  ...
  final case class Headers(
    ...
    private[h2] def frameType: Byte = Headers.`type`
  }
  object Headers {
    final val `type` = 0x1
  ...
  final case class Priority(
    ...
    private[h2] def frameType: Byte = Priority.`type`
  }
  object Priority {
    final val `type` = 0x2
  ...
  final case class RstStream(
    ...
    private[h2] def frameType: Byte = RstStream.`type`
  }
  object RstStream {
    final val `type` = 0x3
  ...
  final case class Settings(
    ...
    private[h2] def frameType: Byte = Settings.`type`
  }
  object Settings {
    final val `type` = 0x4
  ...
  final case class PushPromise(
    ...
    private[h2] def frameType: Byte = PushPromise.`type`
  }
  object PushPromise {
    final val `type` = 0x5
  ...
  final case class Ping(identifier: Int, ack: Boolean, data: ByteVector) extends H2Frame {
    ...
    private[h2] def frameType: Byte = Ping.`type`
  ...
  final case class GoAway(
    ...
    private[h2] def frameType: Byte = GoAway.`type`
  }
  object GoAway {
    final val `type` = 0x7
  ...
  final case class WindowUpdate(identifier: Int, windowSizeIncrement: Int) extends H2Frame {
    ...
    private[h2] def frameType: Byte = WindowUpdate.`type`
  }
  object WindowUpdate {
    final val `type` = 0x8
  ...
  final case class Continuation(
    ...
    private[h2] def frameType: Byte = Continuation.`type`
  }
  object Continuation {
    final val `type` = 0x9
